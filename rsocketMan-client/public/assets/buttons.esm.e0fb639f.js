 ...
 */
var k = window.document, v = window.Math, x = window.HTMLElement, p = window.XMLHttpRequest, z = function (e, r) {
        for (var t = 0, o = e.length; t < o; t++) r(e[t])
    }, y = function (e) {
        return function (r, t, o) {
            var a = e.createElement(r);
            if (t != null) for (var n in t) {
                var l = t[n];
                l != null && (a[n] != null ? a[n] = l : a.setAttribute(n, l))
            }
            return o != null && z(o, function (c) {
                a.appendChild(typeof c == "string" ? e.createTextNode(c) : c)
            }), a
        }
    }, _ = y(k), V = function (e) {
        var r;
        return function () {
            r || (r = 1, e.apply(this, arguments))
        }
    }, m = function (e, r) {
        return {}.hasOwnProperty.call(e, r)
    }, C = function (e) {
        return ("" + e).toLowerCase()
    }, O = "github-buttons", N = "2.21.1", P = "https://" + ("unpkg.com/" + O + "@" + N + "/dist") + "/buttons.html",
    u = "github.com", R = "https://api." + u, G = p && "prototype" in p && "withCredentials" in p.prototype,
    I = G && x && "attachShadow" in x.prototype && !("prototype" in x.prototype.attachShadow), g = function (e, r, t) {
        e.addEventListener ? e.addEventListener(r, t, !1) : e.attachEvent("on" + r, t)
    }, M = function (e, r, t) {
        e.removeEventListener ? e.removeEventListener(r, t, !1) : e.detachEvent("on" + r, t)
    }, $ = function (e, r, t) {
        var o = function () {
            return M(e, r, o), t.apply(this, arguments)
        };
        g(e, r, o)
    }, J = function (e, r, t) {
        if (e.readyState != null) {
            var o = "readystatechange", a = function () {
                if (r.test(e.readyState)) return M(e, o, a), t.apply(this, arguments)
            };
            g(e, o, a)
        }
    }, Q = function (e) {
        var r = {href: e.href, title: e.title, "aria-label": e.getAttribute("aria-label")};
        return z(["icon", "color-scheme", "text", "size", "show-count"], function (t) {
            var o = "data-" + t;
            r[o] = e.getAttribute(o)
        }), r["data-text"] == null && (r["data-text"] = e.textContent || e.innerText), r
    },
    ...
    W = function (e, r, t, o) {
        ...
        e = C(e).replace(/^octicon-/, ""), m(F, e) || (e = "mark-github");
        var t = r >= 24 && 24 in F[e].heights ? 24 : 16, o = F[e].heights[t];
        return '<svg viewBox="0 0 ' + o.width + " " + t + '" width="' + r * o.width / t + '" height="' + r + '" class="octicon octicon-' + e + '" aria-hidden="true">' + o.path + "</svg>"
    }, A = {}, te = function (e, r) {
        var t = A[e] || (A[e] = []);
        if (!(t.push(r) > 1)) {
            var o = V(function () {
                for (delete A[e]; r = t.shift();) r.apply(null, arguments)
            });
            if (G) {
                var a = new p;
                g(a, "abort", o), g(a, "error", o), g(a, "load", function () {
                    var d;
                    try {
                ...
                var n = this || window;
                n._ = function (d) {
                    n._ = null, o(d.meta.status !== 200, d.data)
                };
                var l = y(n.document)("script", {async: !0, src: e + (e.indexOf("?") !== -1 ? "&" : "?") + "callback=_"}),
                    c = function () {
                        n._ && n._({meta: {}})
                    };
                g(l, "load", c), g(l, "error", c), J(l, /de|m/, c), n.document.getElementsByTagName("head")[0].appendChild(l)
            }
        }
    }, D = function (e, r, t) {
        var o = y(e.ownerDocument), a = e.appendChild(o("style", {type: "text/css"})), n = j + re(r["data-color-scheme"]);
        a.styleSheet ? a.styleSheet.cssText = n : a.appendChild(e.ownerDocument.createTextNode(n));
        var l = C(r["data-size"]) === "large", c = o("a", {
                className: "btn",
                href: r.href,
                rel: "noopener",
                target: "_blank",
                title: r.title || void 0,
                "aria-label": r["aria-label"] || void 0,
                innerHTML: oe(r["data-icon"], l ? 16 : 14) + "&nbsp;"
            }, [o("span", {}, [r["data-text"] || ""])]),
            d = e.appendChild(o("div", {className: "widget" + (l ? " widget-lg" : "")}, [c])),
            s = c.hostname.replace(/\.$/, "");
        if (("." + s).substring(s.length - u.length) !== "." + u) {
            c.removeAttribute("href"), t(d);
            return
        }
        var i = (" /" + c.pathname).split(/\/+/);
        if (((s === u || s === "gist." + u) && i[3] === "archive" || s === u && i[3] === "releases" && (i[4] === "download" || i[4] === "latest" && i[5] === "download") || s === "codeload." + u) && (c.target = "_top"), C(r["data-show-count"]) !== "true" || s !== u || i[1] === "marketplace" || i[1] === "sponsors" || i[1] === "orgs" || i[1] === "users" || i[1] === "-") {
            t(d);
            return
        }
        var b, h;
        if (!i[2] && i[1]) h = "followers", b = "?tab=followers"; else if (!i[3] && i[2]) h = "stargazers_count", b = "/stargazers"; else if (!i[4] && i[3] === "subscription") h = "subscribers_count", b = "/watchers"; else if (!i[4] && i[3] === "fork") h = "forks_count", b = "/network/members"; else if (i[3] === "issues") h = "open_issues_count", b = "/issues"; else {
            t(d);
            return
        }
        var B = i[2] ? "/repos/" + i[1] + "/" + i[2] : "/users/" + i[1];
        te.call(this, R + B, function (X, E) {
            if (!X) {
                var w = E[h];
                d.appendChild(o("a", {
                    ...
                    rel: "noopener",
                    target: "_blank",
                    "aria-label": w + " " + h.replace(/_count$/, "").replace("_", " ").slice(0, w < 2 ? -1 : void 0) + " on GitHub"
                }, [("" + w).replace(/\B(?=(\d{3})+(?!\d))/g, ",")]))
            }
            t(d)
        })
    }, L = window.devicePixelRatio || 1, H = function (e) {
        return (L > 1 ? v.ceil(v.round(e * L) / L * 2) / 2 : v.ceil(e)) || 0
    }, ae = function (e) {
        var r = e.offsetWidth, t = e.offsetHeight;
        if (e.getBoundingClientRect) {
            var o = e.getBoundingClientRect();
            r = v.max(r, H(o.width)), t = v.max(t, H(o.height))
        }
        return [r, t]
    }, S = function (e, r) {
        e.style.width = r[0] + "px", e.style.height = r[1] + "px"
    }, ne = function (e, r) {
        if (!(e == null || r == null)) if (e.getAttribute && (e = Q(e)), I) {
            var t = _("span");
            D(t.attachShadow({mode: "closed"}), e, function () {
                r(t)
            })
        } else {
            var o = _("iframe", {
            ...
            S(o, [0, 0]), o.style.border = "none";
            var a = function () {
                var n = o.contentWindow, l;
                try {
                    l = n.document.body
                } catch {
                    k.body.appendChild(o.parentNode.removeChild(o));
                    return
                }
                M(o, "load", a), D.call(n, l, e, function (c) {
                    var d = ae(c);
                    o.parentNode.removeChild(o), $(o, "load", function () {
                        S(o, d)
                    }), o.src = P + "#" + (o.name = W(e)), r(o)
                })
            };
            g(o, "load", a), k.body.appendChild(o)
        }
    };
export {ne as render};
